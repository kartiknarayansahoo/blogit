    ...
    return (
        <div className="flex flex-col justify-center content-center p-8">
            ...
            <div className="flex items-center">
                <div className="bg-gray-500 px-4 py-2 rounded-full text-white">{authorName[0].toUpperCase()}</div>
        ...
        <div className="">
            <div role="status" className="flex flex-col justify-center content-center p-8 animate-pulse">
                ...
                <div className="flex items-center min-w-xs sm:min-w-sm lg:min-w-lg xl:min-w-xl">
                    <div className="h-5 bg-violet-200 rounded-full w-1/5 mb-4 mr-2 z-"></div>
                    <div className="h-5 bg-violet-200 rounded-full  w-1/10 mb-4"></div>
                    <div className="h-4 bg-violet-200 rounded-full  mb-2.5"></div>
                </div>
                {/* title */}
                <div className="text-3xl pt-2">
                    <div className="h-3 bg-violet-200 rounded-full w-2/5 mb-2.5"></div>

                </div>
                {/* body */}
                <div className="h-3 bg-violet-200 rounded-full max-w-[full] mb-2"></div>
                <div className="h-3 bg-violet-200 rounded-full max-w-[full]"></div>
            </div>
        </div>
